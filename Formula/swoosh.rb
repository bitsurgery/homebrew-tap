...
class Swoosh < Formula
  ...
  on_macos do
    on_arm do
      ...
      url "https://github.com/bitsurgery/swoosh/releases/download/v0.2.1/swoosh-0.2.1-aarch64-apple-darwin.tar.gz"
      sha256 "751946c8bf56aae2df658b435e5a63e8f0bb0fdc3b88cbcebad8e60f9e6f0aa0"
    end
