...
class Swoosh < Formula
  ...
  on_macos do
    on_arm do
      ...
      url "https://github.com/bitsurgery/swoosh/releases/download/v0.2.16/swoosh-0.2.16-aarch64-apple-darwin.tar.gz"
      sha256 "1280c949cf50e82a996af3d28d9573bc9add2b2d29d98525cb0ad8ceb6bb6fb4"
    end
