...
class Swoosh < Formula
  ...
  on_macos do
    on_arm do
      ...
      url "https://github.com/bitsurgery/swoosh/releases/download/v0.2.5/swoosh-0.2.5-aarch64-apple-darwin.tar.gz"
      sha256 "2a6b1cb5b5d34c08007899f8b31378c95207a94db590ec615cfd0c61c1b1c4e0"
    end
