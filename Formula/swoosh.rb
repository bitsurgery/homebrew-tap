...
class Swoosh < Formula
  ...
  on_macos do
    on_arm do
      ...
      url "https://github.com/bitsurgery/swoosh/releases/download/v0.1.13/swoosh-0.1.13-aarch64-apple-darwin.tar.gz"
      sha256 "f1285c1c3b3b097569e4dbe29fbb18bf1dec159387572c641ce103cf5ca1990e"
    end
