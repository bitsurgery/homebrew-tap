...
class Swoosh < Formula
  ...
  on_macos do
    on_arm do
      ...
      url "https://github.com/bitsurgery/swoosh/releases/download/v0.2.31/swoosh-0.2.31-aarch64-apple-darwin.tar.gz"
      sha256 "0b455263756c23e8fd29118f4bb0afbb83ac162c005d446684236f25168aa5e6"
    end
