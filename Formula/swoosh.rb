...
class Swoosh < Formula
  ...
  on_macos do
    on_arm do
      ...
      url "https://github.com/bitsurgery/swoosh/releases/download/v0.1.9/swoosh-0.1.9-aarch64-apple-darwin.tar.gz"
      sha256 "285ab24d201155ff9ffb1c3e83536d028ecf96067d9f27190cc14c170977aa92"
    end
