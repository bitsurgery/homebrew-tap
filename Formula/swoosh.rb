...
class Swoosh < Formula
  ...
  on_macos do
    on_arm do
      ...
      url "https://github.com/bitsurgery/swoosh/releases/download/v0.2.7/swoosh-0.2.7-aarch64-apple-darwin.tar.gz"
      sha256 "aba39a8c8f7f1586f33143cc8093bb6569bb90bcbed6262eb4e3aba7376e6545"
    end
