...
class Swoosh < Formula
  ...
  on_macos do
    on_arm do
      ...
      url "https://github.com/bitsurgery/swoosh/releases/download/v0.1.18/swoosh-0.1.18-aarch64-apple-darwin.tar.gz"
      sha256 "f14a0d9764af39e04561c17b4fc85122660ab70d7e9b1990f37eb6f604f33b45"
    end
