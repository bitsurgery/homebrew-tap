...
class Swoosh < Formula
  ...
  on_macos do
    on_arm do
      ...
      url "https://github.com/bitsurgery/swoosh/releases/download/v0.1.10/swoosh-0.1.10-aarch64-apple-darwin.tar.gz"
      sha256 "e1d2329af094a48726d55bf3d5178fefe2b97dfbc9e852ed2922677d7ecc6075"
    end
