...
class Swoosh < Formula
  ...
  on_macos do
    on_arm do
      ...
      url "https://github.com/bitsurgery/swoosh/releases/download/v0.2.6/swoosh-0.2.6-aarch64-apple-darwin.tar.gz"
      sha256 "b117963fa9e8e41c445886bc4c54ae187430d8fee5f42b35bee736d935991db0"
    end
