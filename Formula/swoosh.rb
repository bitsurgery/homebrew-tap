...
class Swoosh < Formula
  ...
  on_macos do
    on_arm do
      ...
      url "https://github.com/bitsurgery/swoosh/releases/download/v0.2.27/swoosh-0.2.27-aarch64-apple-darwin.tar.gz"
      sha256 "f3eb8b711fcfcff853917eb82ecd766e33ac131d414ee87d0b5f77f1aba6a38e"
    end
