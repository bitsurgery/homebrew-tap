...
class Swoosh < Formula
  ...
  on_macos do
    on_arm do
      ...
      url "https://github.com/bitsurgery/swoosh/releases/download/v0.2.2/swoosh-0.2.2-aarch64-apple-darwin.tar.gz"
      sha256 "bee908d8526c618f5407cad5f2fcff0d42016eae902d956c586b23c5dbfc8d70"
    end
