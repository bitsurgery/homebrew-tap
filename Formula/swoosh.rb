...
class Swoosh < Formula
  ...
  on_macos do
    on_arm do
      ...
      url "https://github.com/bitsurgery/swoosh/releases/download/v0.2.21/swoosh-0.2.21-aarch64-apple-darwin.tar.gz"
      sha256 "ccaa05850bf048a4a7bb6cbb911a831ff9429e671ae2e0a4156ae136ca31e026"
    end
