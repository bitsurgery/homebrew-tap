...
class Swoosh < Formula
  ...
  on_macos do
    on_arm do
      ...
      url "https://github.com/bitsurgery/swoosh/releases/download/v0.1.19/swoosh-0.1.19-aarch64-apple-darwin.tar.gz"
      sha256 "27e37373d2bff40411b66fa9fcd8fd3af01d12bb6a71fc2709ee6e25ba1fef8e"
    end
