...
class Swoosh < Formula
  ...
  on_macos do
    on_arm do
      ...
      url "https://github.com/bitsurgery/swoosh/releases/download/v0.2.14/swoosh-0.2.14-aarch64-apple-darwin.tar.gz"
      sha256 "c65b9c11e2031e821c312b11d701678ca44baa885937f8a17c7a95d73bc4d8c8"
    end
