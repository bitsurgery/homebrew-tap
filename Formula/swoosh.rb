...
class Swoosh < Formula
  ...
  on_macos do
    on_arm do
      ...
      url "https://github.com/bitsurgery/swoosh/releases/download/v0.2.20/swoosh-0.2.20-aarch64-apple-darwin.tar.gz"
      sha256 "1eb4bf8ebc754cc60e1525d01afed1b850c2fa09cd1d869eb339b395784852ed"
    end
