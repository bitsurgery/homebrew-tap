...
class Swoosh < Formula
  ...
  on_macos do
    on_arm do
      ...
      url "https://github.com/bitsurgery/swoosh/releases/download/v0.2.3/swoosh-0.2.3-aarch64-apple-darwin.tar.gz"
      sha256 "c3f94153f50e503d35976a383a5db871331376068b04c36e039678cfd113d574"
    end
