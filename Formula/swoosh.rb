...
class Swoosh < Formula
  ...
  on_macos do
    on_arm do
      ...
      url "https://github.com/bitsurgery/swoosh/releases/download/v0.2.26/swoosh-0.2.26-aarch64-apple-darwin.tar.gz"
      sha256 "c0f70f1170c0e17172d1bb209b2c50319aff6da2062f12485c70e29b0d6d6f97"
    end
