...
class Swoosh < Formula
  ...
  on_macos do
    on_arm do
      ...
      url "https://github.com/bitsurgery/swoosh/releases/download/v0.1.17/swoosh-0.1.17-aarch64-apple-darwin.tar.gz"
      sha256 "e1d08fd44c9289a28d1341770c34e70179b8157da57fc7a9b1ce20eb2701c1d0"
    end
