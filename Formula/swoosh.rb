...
class Swoosh < Formula
  ...
  on_macos do
    on_arm do
      ...
      url "https://github.com/bitsurgery/swoosh/releases/download/v0.2.23/swoosh-0.2.23-aarch64-apple-darwin.tar.gz"
      sha256 "c0700fc1c3bf994f3b7eee4f33b59811e04574a6686055445c5ff56aa67c7bf7"
    end
