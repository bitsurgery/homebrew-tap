...
class Swoosh < Formula
  ...
  on_macos do
    on_arm do
      ...
      url "https://github.com/bitsurgery/swoosh/releases/download/v0.2.17/swoosh-0.2.17-aarch64-apple-darwin.tar.gz"
      sha256 "8fd309722ef8e782f657ee2d7611cbbaebf1274278f17075ddc3461e48a3c772"
    end
