...
class Swoosh < Formula
  ...
  on_macos do
    on_arm do
      ...
      url "https://github.com/bitsurgery/swoosh/releases/download/v0.2.11/swoosh-0.2.11-aarch64-apple-darwin.tar.gz"
      sha256 "59f920040b90547337596119bb0d23ba286106227a703d151230ca43b96c27f2"
    end
