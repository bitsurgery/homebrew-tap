...
class Swoosh < Formula
  ...
  on_macos do
    on_arm do
      ...
      url "https://github.com/bitsurgery/swoosh/releases/download/v0.1.11/swoosh-0.1.11-aarch64-apple-darwin.tar.gz"
      sha256 "1fdf1950e87f5679d1900d88c94a7590f7cc41e3176749fdaa98c1dab01019bd"
    end
