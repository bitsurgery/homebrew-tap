...
class Swoosh < Formula
  ...
  on_macos do
    on_arm do
      ...
      url "https://github.com/bitsurgery/swoosh/releases/download/v0.2.0/swoosh-0.2.0-aarch64-apple-darwin.tar.gz"
      sha256 "bbfd19edb05aedeb380cd9ccb7adcb33add081a8492492f9163ebe9b4d4422b2"
    end
