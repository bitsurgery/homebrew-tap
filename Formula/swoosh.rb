...
class Swoosh < Formula
  ...
  on_macos do
    on_arm do
      ...
      url "https://github.com/bitsurgery/swoosh/releases/download/v0.1.15/swoosh-0.1.15-aarch64-apple-darwin.tar.gz"
      sha256 "1d4c9a021d651e190948991bec12dddfac2b77ef969303973abe33a0c3fb6a0d"
    end
