...
class Swoosh < Formula
  ...
  on_macos do
    on_arm do
      ...
      url "https://github.com/bitsurgery/swoosh/releases/download/v0.2.19/swoosh-0.2.19-aarch64-apple-darwin.tar.gz"
      sha256 "6485908d3372761db154d98f2faa275d89d5242025d4f2e7636d6ef919de4d6a"
    end
