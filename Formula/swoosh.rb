...
class Swoosh < Formula
  ...
  on_macos do
    on_arm do
      ...
      url "https://github.com/bitsurgery/swoosh/releases/download/v0.2.22/swoosh-0.2.22-aarch64-apple-darwin.tar.gz"
      sha256 "667af4297548dda3315997726e72320a7015a41858c0accf3b6a89cd20617d43"
    end
