...
class Swoosh < Formula
  ...
  on_macos do
    on_arm do
      ...
      url "https://github.com/bitsurgery/swoosh/releases/download/v0.2.10/swoosh-0.2.10-aarch64-apple-darwin.tar.gz"
      sha256 "7091fe607edff024e5d58c22c5a264ae5a1cb6a5caeae35c3f5dab68788678a6"
    end
