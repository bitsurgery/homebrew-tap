...
class Swoosh < Formula
  ...
  on_macos do
    on_arm do
      ...
      url "https://github.com/bitsurgery/swoosh/releases/download/v0.2.18/swoosh-0.2.18-aarch64-apple-darwin.tar.gz"
      sha256 "6aa6fba84e33dc3e1d56f28121993f8492f0b82fff64e42ebb90acc20eabfc3d"
    end
