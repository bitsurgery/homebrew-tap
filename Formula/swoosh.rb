...
class Swoosh < Formula
  ...
  on_macos do
    on_arm do
      ...
      url "https://github.com/bitsurgery/swoosh/releases/download/v0.2.8/swoosh-0.2.8-aarch64-apple-darwin.tar.gz"
      sha256 "ce5ec204ef7ccd1a25f2798dddbbea94971688c35fb9c1c34c99caa24626ba69"
    end
