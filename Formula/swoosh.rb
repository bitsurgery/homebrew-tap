...
class Swoosh < Formula
  ...
  on_macos do
    on_arm do
      ...
      url "https://github.com/bitsurgery/swoosh/releases/download/v0.2.4/swoosh-0.2.4-aarch64-apple-darwin.tar.gz"
      sha256 "4a4a9510967b73fb2c72ded03182eac9d580ff8add039157e1d932fe05101c07"
    end
