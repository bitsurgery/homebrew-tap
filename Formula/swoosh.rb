...
class Swoosh < Formula
  ...
  on_macos do
    on_arm do
      ...
      url "https://github.com/bitsurgery/swoosh/releases/download/v0.1.14/swoosh-0.1.14-aarch64-apple-darwin.tar.gz"
      sha256 "e2e538afd7c6456fb4f3e1430c1f61d2cbc36337a79ddf1ae517e2aaf178dc8e"
    end
