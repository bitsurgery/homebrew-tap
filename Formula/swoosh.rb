...
class Swoosh < Formula
  ...
  on_macos do
    on_arm do
      ...
      url "https://github.com/bitsurgery/swoosh/releases/download/v0.2.28/swoosh-0.2.28-aarch64-apple-darwin.tar.gz"
      sha256 "02243b9efa95ef3004d733f6369f2bd7d7aced80f871cf6673d9e2bc96595f96"
    end
