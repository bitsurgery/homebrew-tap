...
class Swoosh < Formula
  ...
  on_macos do
    on_arm do
      ...
      url "https://github.com/bitsurgery/swoosh/releases/download/v0.2.25/swoosh-0.2.25-aarch64-apple-darwin.tar.gz"
      sha256 "e00f6fc70612b5e6e32d9d0374c92c1895b007e3e5e4565ed9500bc39e58f2e8"
    end
