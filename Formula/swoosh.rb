...
class Swoosh < Formula
  ...
  on_macos do
    on_arm do
      ...
      url "https://github.com/bitsurgery/swoosh/releases/download/v0.2.24/swoosh-0.2.24-aarch64-apple-darwin.tar.gz"
      sha256 "690f2f6c384415dc6dc8a32c07ae27bb6b73c46e0bfcae41920283d0be1bbab7"
    end
